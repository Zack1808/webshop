...
import { STRIPE_KEY } from "../data/data";
            ...
            <form onSubmit={(e) => handleSubmit(e, elements, stripe)}>
              <div className="input-select full-width">
                ...
                <select name="payment">
                  ...
                  {token.subtotal.raw > 100 && (
                    <option value="twelve">12 Month Installment</option>
                  )}
                  {token.subtotal.raw > 500 && (
                    <option value="twentyfour">24 Month Installment</option>
                  )}
                  {token.subtotal.raw > 1000 && (
                    <option value="thirtysix">36 Month Installment</option>
                  )}
                </select>
              </div>
              <span>
